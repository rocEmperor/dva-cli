...
function CompanyManagement(props) {
  ...
  const menus = [{ id: 1, name: '一级', children: [{ id: 2, name: '二级', children: [{ id: 4, name: '三级', children: [{ id: 6, name: '四级', children: [{ id: 8, name: '五级五级五级五级五级五级五级五级五级五级五级五级五级五级五级' }, { id: 9, name: '五级' }] }, { id: 7, name: '四级' }] }, { id: 5, name: '三级' }]}, { id: 3, name: '二级' }]}]
  return (
    <div>
      ...
      <Card>
        <Row>
          <Col span={6}>
            <TreeMenu menus={menus} change={change.bind(this)}/>
          </Col>
          <Col span={18}>
