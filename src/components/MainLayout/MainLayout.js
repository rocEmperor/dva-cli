...
class MainLayout extends React.Component {
  ...
  render(){
    let { passwordsMainLay, form } = this.props;
    ...
    return (
      <LocaleProvider locale={zhCN}>
        <Layout>
          ...
          <Layout>
            <Sider style={{ minHeight: document.body.scrollHeight - 64 }} collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse}>
              ...
              <Menu
                ...
                <SubMenu key="01" title={<span><Icon type="folder" /><span>基础资料</span></span>}>
                  <Menu.Item key="0101">
                    <Link to={'/homePage'}>房产资料</Link>
                  </Menu.Item>
                  <Menu.Item key="0102">
                    <Link to={'/homePages'}>客户资料</Link>
                  </Menu.Item>
                  <Menu.Item key="0103">
                    <Link to={'/homePages'}>户型图资料</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="02" title={<span><Icon type="notification" /><span>小区公告</span></span>}>
                  <Menu.Item key="0201">
                    <Link to={'/homePage'}>小区公告</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="03" title={<span><Icon type="bell" /><span>智能门禁</span></span>}>
                  <Menu.Item key="0301">
                    <Link to={'/homePage'}>智能门禁管理</Link>
                  </Menu.Item>
                  <Menu.Item key="0302">
                    <Link to={'/homePage'}>开门记录</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="04" title={<span><Icon type="home" /><span>验房收房</span></span>}>
                  <Menu.Item key="0401">
                    <Link to={'/homePage'}>工单管理</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="05" title={<span><Icon type="bank" /><span>租赁管理</span></span>}>
                  <Menu.Item key="0501">
                    <Link to={'/homePage'}>意向客户</Link>
                  </Menu.Item>
                  <Menu.Item key="0502">
                    <Link to={'/homePage'}>出售房源管理</Link>
                  </Menu.Item>
                  <Menu.Item key="0503">
                    <Link to={'/homePage'}>出租房源管理</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="06" title={<span><Icon type="shopping-cart" /><span>二手市场</span></span>}>
                  <Menu.Item key="0601">
                    <Link to={'/homePage'}>二手市场管理</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="07" title={<span><Icon type="search" /><span>便民查询</span></span>}>
                  <Menu.Item key="0701">
                    <Link to={'/homePage'}>便民查询</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="08" title={<span><Icon type="youtube" /><span>视频监控</span></span>}>
                  <Menu.Item key="0801">
                    <Link to={'/homePage'}>视频监控</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="09" title={<span><Icon type="cluster" /><span>系统管理</span></span>}>
                  <Menu.Item key="0901">
                    <Link to={'/homePage'}>角色管理</Link>
                  </Menu.Item>
                  <Menu.Item key="0902">
                    <Link to={'/homePage'}>部门管理</Link>
                  </Menu.Item>
                  <Menu.Item key="0903">
                    <Link to={'/homePage'}>员工管理</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu key="10" title={<span><Icon type="shake" /><span>app管理</span></span>}>
                  <Menu.Item key="1001">
                    <Link to={'/homePage'}>服务管理</Link>
                  </Menu.Item>
                  <Menu.Item key="1002">
                    <Link to={'/homePage'}>菜单管理</Link>
                  </Menu.Item>
                </SubMenu>
              </Menu>
            </Sider>
